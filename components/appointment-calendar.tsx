...
export function AppointmentCalendar({ appointments, onAppointmentClick, onDateClick }: AppointmentCalendarProps) {
            ...
            return (
              <div
                ...
                className={`p-1 h-24 border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors ${
                  isToday(day) ? "bg-secondary/20 border-secondary" : "border-border"
                }`}
                onClick={() => onDateClick(dateString)}
              >
                <div className="flex justify-between items-start mb-1">
                  <span className={`text-sm font-medium ${isToday(day) ? "text-secondary" : "text-foreground"}`}>
                    {day}
                  </span>
                    ...
                    >
                      <div className="flex items-center gap-1">
                        ...
                        <span className="truncate">
                          {appointment.appointmentTime} {appointment.patient.firstName}
                        </span>
                      </div>
                    </div>
                  ))}
